...
def obter_dados_das_fontes():
    ...
    with open("Datasets/Comentarios_fanta_guarana.txt", "r") as arquivo_texto:
        dados = arquivo_texto.read().split('\n')
         
    with open("Datasets/Comentarios_coca_cola.txt", "r") as arquivo_texto:
        dados += arquivo_texto.read().split('\n')
...
exibir_resultado( analisar_frase(classificador, vetorizador,"o melhor refrigerante"))
exibir_resultado( analisar_frase(classificador, vetorizador,"o pior refrigerante"))
exibir_resultado( analisar_frase(classificador, vetorizador,"impressionante!"))
